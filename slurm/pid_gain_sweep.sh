#!/bin/bash -l
#SBATCH --job-name=sr_cpo_pid
#SBATCH --output=safe_pid.%A_%a.out
#SBATCH --error=safe_pid.%A_%a.err
...
PID_LABELS=("pid_soft" "pid_base" "pid_strong")
PID_KPS=("2.5" "5.0" "10.0")
PID_KIS=("0.05" "0.1" "0.2")
PID_KD="0.0"
TASK_ID="${SLURM_ARRAY_TASK_ID:-0}"
PID_LABEL="${PID_LABELS[$TASK_ID]}"
