#!/bin/bash -l
#SBATCH --job-name=sr_cpo_effect
#SBATCH --output=safe_effect.%A_%a.out
#SBATCH --error=safe_effect.%A_%a.err
...
EFFECT_LABELS=(
    ...
    "constrained_seed0" "constrained_seed1" "constrained_seed2"
)
EFFECT_MODES=(
...
SEEDS=("0" "1" "2" "0" "1" "2")
PID_KPS=("0.0" "0.0" "0.0" "5.0" "5.0" "5.0")
PID_KIS=("0.0" "0.0" "0.0" "0.1" "0.1" "0.1")
PID_KD="0.0"
TASK_ID="${SLURM_ARRAY_TASK_ID:-0}"
EFFECT_LABEL="${EFFECT_LABELS[$TASK_ID]}"
EFFECT_MODE="${EFFECT_MODES[$TASK_ID]}"
SEED="${SEEDS[$TASK_ID]}"
...
echo "EFFECT_LABEL=$EFFECT_LABEL"
echo "EFFECT_MODE=$EFFECT_MODE"
echo "SEED=$SEED"
echo "NU_C=$NU_C"
