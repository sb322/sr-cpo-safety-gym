#!/bin/bash -l
#SBATCH --job-name=sr_cpo_r200
#SBATCH --output=safe_relxy_200.%A_%a.out
#SBATCH --error=safe_relxy_200.%A_%a.err
...
echo "===== RELATIVE-XY 200-EPOCH 3-SEED COMPARISON ====="
...
echo "COST_MODE_OVERRIDE=${COST_MODE_OVERRIDE:-sparse}"
echo "COST_DENSE_PROX_TAU_OVERRIDE=${COST_DENSE_PROX_TAU_OVERRIDE:-0.5}"
