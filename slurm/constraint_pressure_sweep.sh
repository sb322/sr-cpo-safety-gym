#!/bin/bash -l
#SBATCH --job-name=sr_cpo_press
#SBATCH --output=safe_pressure.%A_%a.out
#SBATCH --error=safe_pressure.%A_%a.err
...
PRESSURE_LABELS=("nuc1" "nuc1e-2" "nuc1e-3" "nuc3e-4" "nuc1e-4")
NU_C_VALUES=("1.0" "0.01" "0.001" "0.0003" "0.0001")
TASK_ID="${SLURM_ARRAY_TASK_ID:-0}"
PRESSURE_LABEL="${PRESSURE_LABELS[$TASK_ID]}"
NU_C="${NU_C_VALUES[$TASK_ID]}"
SEED="0"
COST_LIMIT="0.0001"
PID_KP="5.0"
PID_KI="0.1"
