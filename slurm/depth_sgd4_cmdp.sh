...
#SBATCH --output=safe_depth_cmdp.%A_%a.out
#SBATCH --error=safe_depth_cmdp.%A_%a.err
...
DEPTH_LABELS=("depth4_cmdp" "depth8_cmdp" "depth16_cmdp" "depth32_cmdp")
...
# 3. Phase-1g alpha cap, calibrated default budget, and residual depth switch
