#!/bin/bash -l
#SBATCH --job-name=sr_cpo_dcmdp
#SBATCH --output=safe_relxy_depth_cmdp.%A_%a.out
#SBATCH --error=safe_relxy_depth_cmdp.%A_%a.err
...
echo "===== RELATIVE-XY CMDP 200-EPOCH DEPTH SWEEP ====="
