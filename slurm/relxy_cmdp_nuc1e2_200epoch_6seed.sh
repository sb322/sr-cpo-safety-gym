#!/bin/bash -l
#SBATCH --job-name=sr_cpo_r1e2
#SBATCH --output=safe_relxy_200_nuc1e2.%A_%a.out
#SBATCH --error=safe_relxy_200_nuc1e2.%A_%a.err
...
echo "===== RELATIVE-XY CMDP NU_C=1E-2 200-EPOCH 6-SEED ====="
...
echo "NU_C_OVERRIDE=0.01"
echo "PID_KP_OVERRIDE=5.0"
echo "PID_KI_OVERRIDE=0.01"
echo "PID_KD_OVERRIDE=0.0"
echo "PID_INTEGRAL_DECAY_OVERRIDE=0.95"
...
export NU_C_OVERRIDE=0.01
export PID_KP_OVERRIDE=5.0
export PID_KI_OVERRIDE=0.01
export PID_KD_OVERRIDE=0.0
export PID_INTEGRAL_DECAY_OVERRIDE=0.95
