#!/bin/bash -l
#SBATCH --job-name=sr_cpo_dsgd4
#SBATCH --output=safe_depth_sgd4.%A_%a.out
#SBATCH --error=safe_depth_sgd4.%A_%a.err
...
DEPTH_LABELS=("depth4_sgd4" "depth8_sgd4" "depth16_sgd4" "depth32_sgd4")
