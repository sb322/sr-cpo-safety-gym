#!/bin/bash -l
#SBATCH --job-name=sr_cpo_d8_sgd
#SBATCH --output=safe_depth8_sgd.%A_%a.out
#SBATCH --error=safe_depth8_sgd.%A_%a.err
...
SGD_LABELS=("sgd1" "sgd2" "sgd4")
SGD_STEPS=("1" "2" "4")
TASK_ID="${SLURM_ARRAY_TASK_ID:-0}"
SGD_LABEL="${SGD_LABELS[$TASK_ID]}"
SGD_STEP="${SGD_STEPS[$TASK_ID]}"
SEED="0"
NUM_BLOCKS="8"
COST_LIMIT="0.0001"
PID_KP="5.0"
...
echo "SGD_LABEL=$SGD_LABEL"
echo "SGD_STEPS=$SGD_STEP"
